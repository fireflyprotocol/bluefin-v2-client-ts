...
export enum Errors {
  ...
  SIGN_TX_FAILED = "SIGN_TX_FAILED",
  DAPI_ERROR = "DAPI_ERROR",
  DEPOSIT_TO_MARGIN_BANK_FAILED = "DEPOSIT_TO_MARGIN_BANK_FAILED",
  BUILD_GAS_LESS_TX_FAIED = "BUILD_GAS_LESS_TX_FAIED",
  EXECUTE_SPONSORED_TX_FAILED = "EXECUTE_SPONSORED_TX_FAILED",
  UNKNOWN = "UNKNOWN",
}
